...
wheels = ['Spin_Plus.csv', 'New_Year_2023_Wheel.csv', 'Holidays_2022_Wheel.csv', 'September_Premium_Wheel.csv', 'Summer_Wheel_2.csv', 'Summer_Wheel.csv', 'Revamped_June_Wheel.csv', 'June_Wheel.csv', 'Late_May_Wheel.csv',
